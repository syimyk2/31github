...
const CampSite = ({ title, subTitle, bgImage, peopleJoined }: CampProps) => {
	return (
		<div
			className={`h-full w-full min-w-[1100px] ${bgImage} bg-no-repeat bg-cover lg:rounded-r-5xl 2xl:rounded-5xl `}
		>
...
const Camp = () => {
	return (
		<section className='2xl:max-container relative flex flex-col py-10 mb-10 lg:py-20 xl:mb-20'>
			<div className=' hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
				<CampSite
					title='Putuk bruno Camp'
			...
			<div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
				<div className='bg-green-500 p-8 lg:max-w-[500px] xl:max-w-[734px]  xl:rounded-5xl  xl:px-16  xl:py-20 relative w-full overflow-hidden rounded-3xl'>
					<h2 className=' regular-24 capitalize  md:regular-32 2xl:regular-64 text-white'>
